...
title: Arcus CRM
slug: arcus-crm
description: AI-powered sales CRM with Kanban pipeline, contact management, and a conversational agent that creates deals, generates scripts, and analyses opportunities — built on Next.js and Supabase.
date: 2026-03-29
featured: true
ordering: 2
